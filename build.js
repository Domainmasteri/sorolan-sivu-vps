...
const IGNORE_NAMES = new Set(['i18n']);
...
/**
 * UUSI ÄLYKÄS KATEGORISOINTI:
 * Kerää automaattisesti kaikki "__"-alkuiset lohkot (esim. __common_nav__, __common_forms__,
 * __common_tools__, __common_legal__) globaaleiksi perussäännöiksi.
 */
function getRules(section = {}, relativePath) {
  ...
  for (const [key, val] of Object.entries(section)) {
    if (key.startsWith('__')) {
      Object.assign(commonText, val.text || {});
      Object.assign(commonAttributes, val.attributes || {});
      Object.assign(commonRaw, val.raw || {});
    }
  }

  const specific = section[relativePath] || {};
  return {
    text: { ...commonText, ...(specific.text || {}) },
    attributes: { ...commonAttributes, ...(specific.attributes || {}) },
    raw: { ...commonRaw, ...(specific.raw || {}) }
  };
}
